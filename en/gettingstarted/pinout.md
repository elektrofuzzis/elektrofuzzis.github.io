  ...
  <div>
    ...
    <div>
      <p class="pdetail">
        ...
        <br><br>
        Since it is specifically optimized for battery operation starting at 4.6V, it can be powered by the wheel drive’s battery compartment. Please note that you must install a LiPo battery inside the housing to operate the ftSwarmRC.<br><br>
