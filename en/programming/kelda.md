...
![Home](/assets/img/kelda_principle.png)

Since all controllers have a powerful ESP32 processor, one controller in the swarm becomes a Kelda. It takes over the control and sends control commands to the other controllers via wifi or RS485. All other controllers report their sensor states back, so Kelda knows about everything.
