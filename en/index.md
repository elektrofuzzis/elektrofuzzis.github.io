...
<div class="hero-image-wrap">
    ...
    <a class="hero-version-popup" href="/en/firmware/versions">New version 0.7.1 available.<br>Read upgrade guide!</a>
</div>
...
<div class="table-3-col">
    ...
    <div>
        ...
        <div>
            <p class="pdetail">
            The ftSwarmRC replaces both the 4-channel RC receiver (3246X) and the RC radio receiver (30272) from the 1980s.<br><br>
            However, it can do more than the classic fischertechnik RC receivers: It can control a wheel drive, up to 4 RC servos and standard motors, as well as up to 6 sensors.
            </p>
        </div>
    </div>
    <div>
